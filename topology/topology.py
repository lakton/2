...
if __name__ == "__main__":
    ...
    net.get("ds1").cmd("python3 /home/sdn/Desktop/2/application/sdn/ext/dns_server.py >> dns.log 2>&1")
    ...
    net.get("ws1").cmd("python3 -m http.server 80 --bind 100.0.0.40 >> www1.log 2>&1")
    net.get("ws1").cmd("python3 -m http.server 80 --bind 100.0.0.41 >> www2.log 2>&1")
    net.get("ws1").cmd("python3 -m http.server 80 --bind 100.0.0.42 >> www3.log 2>&1")
