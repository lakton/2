...
#### 1. Тест коннекта
   - `connectivity.sh` -> **для запуска тестов связности между хостами и/или серверами и/или балансировщиками нагрузки**
   - `connectivity_test_results` -> **выходные результаты для тестов**
